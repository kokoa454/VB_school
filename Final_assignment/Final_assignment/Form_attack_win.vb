...
Public Class Form_attack_win
    ...
    Private Sub Form_attack_win_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub PlayNextMusic()
        'play Свещенная_Война.mp3
        playMusic("..\..\..\music\Свещенная_Война.mp3")
    End Sub
